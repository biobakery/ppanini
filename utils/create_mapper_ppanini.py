...
if __name__ == '__main__':
	...
	parser.add_argument('--go_mapper', help='', required=True)
	parser.add_argument('--basename', default=False, help='')
	parser.add_argument('--color_go', default='blue', help='')
	parser.add_argument('--color_uniref90', default='red', help='')
	parser.add_argument('--color_unknown', default='yellow', help='')
	parser.add_argument('--zorder_go', default=2, help='')
	parser.add_argument('--zorder_uniref90', default=1, help='')
	parser.add_argument('--zorder_unknown', default=3, help='')
